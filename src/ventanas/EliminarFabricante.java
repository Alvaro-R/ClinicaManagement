...
public class EliminarFabricante extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EliminarFabricante frame = new EliminarFabricante();
	...
	public EliminarFabricante() {
		...
		JLabel lblNewLabel = new JLabel("Eliminar Fabricante");
		lblNewLabel.setBounds(162, 6, 126, 16);
		...
		JButton btnEliminarFabricante = new JButton("Eliminar fabricante");
		btnEliminarFabricante.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				try {
					Fabricante fabricante = new Fabricante(nombre.getText(),nombre_abreviado.getText());
					
					bbdd.Fabricantes.eliminarFabricante(fabricante);
					
					JOptionPane.showMessageDialog(null,"FABRICANTE ELIMINADO CORRECTAMENTE",
		...
		btnEliminarFabricante.setBounds(6, 108, 159, 29);
		contentPane.add(btnEliminarFabricante);
